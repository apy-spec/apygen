...
static_addition = 60 + 7
dynamic_addition = assign + 8
other_dynamic_addition = assign + static_addition

static_subtraction = 10 - 4
dynamic_subtraction = assign - 5
other_dynamic_subtraction = assign - static_subtraction

static_multiplication = 6 * 7
...
other_dynamic_left_shift = assign << static_left_shift

static_right_shift = 16 >> 2
dynamic_right_shift = assign >> 1
other_dynamic_right_shift = assign >> static_right_shift

static_bitwise_or = 0b1010 | 0b0101
dynamic_bitwise_or = assign | 0b0011
other_dynamic_bitwise_or = assign | static_bitwise_or

static_bitwise_and = 0b1010 & 0b0101
dynamic_bitwise_and = assign & 0b0011
